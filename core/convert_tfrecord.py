...
def main(argv):
    ...
    parser.add_argument("--dataset_txt", default='D:/tensorflow-yolov3/tensorflow-slim-yolov3-master/tensorflow-slim-yolov3-master/data/dataset/voc_test.txt')
    parser.add_argument("--tfrecord_path_prefix", default='D:/tensorflow-yolov3/tensorflow-slim-yolov3-master/tensorflow-slim-yolov3-master/data/tfrecords/voc_test')
